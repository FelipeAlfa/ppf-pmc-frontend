...
export const createEmptySearchParamsState = (): SearchParamsState => ({
...
export const createSearchParamsStateFromParams = (
  params: Record<string, string>
): SearchParamsState => ({
  ...createEmptySearchParamsState(),
  text: normalizeStringValue(params.q),
  people: params.person ? [params.person] : [],
  events: params.event ? [params.event] : [],
  locations: params.location ? [params.location] : [],
  photographers: params.photographer ? [params.photographer] : [],
});
